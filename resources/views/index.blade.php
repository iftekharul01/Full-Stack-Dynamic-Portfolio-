...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><a href="{{url('/welcome')}}">Profile</a></li>
                <li><a href="{{url('/skills')}}">Skills</a></li>
                <li><a href="{{url('/goals')}}">Goals</a></li>
                <li><a href="{{url('/parents')}}">Parents</a></li>
                ...
                <li class="nav-dropdown">
                    <select class="nav-select" onchange="location = this.value;">
                        ...
                        <option value="{{url('/school')}}">School</option>
                        <option value="{{url('/college')}}">College</option>
                        <option value="{{url('/university')}}">University</option>
                    </select>
                </li>

                <li><a href="{{url('/photography')}}">My Photography</a></li>
            </ul>
        </nav>
    </header>
    @yield('main-content')

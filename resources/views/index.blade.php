...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><a href="{{url('/index.blade.php')}}">Profile</a></li>
                <li><a href="{{url('/skills.blade.php')}}">Skills</a></li>
                <li><a href="{{url('/goals.blade.php')}}">Goals</a></li>
                <li><a href="{{url('/parents.blade.php')}}">Parents</a></li>
                <li><a href="{{url('/achievement.blade.php')}}">Achievements</a></li>
                <li class="nav-dropdown">
                    <select class="nav-select" onchange="location = this.value;">
                        <option selected disabled>Education</option>
                        <option value="{{url('/school.blade.php')}}">School</option>
                        <option value="{{url('/college.blade.php')}}">College</option>
                        <option value="{{url('/university.blade.php')}}">University</option>
                    </select>
                </li>
...
<p>mail: islam15-5308@diu.edu.bd</p>
